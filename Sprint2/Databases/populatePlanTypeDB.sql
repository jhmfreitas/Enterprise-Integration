...
INSERT INTO `operatorManagementDB`.`planType` (`plan`) VALUES ('passT2');
INSERT INTO `operatorManagementDB`.`planType` (`plan`) VALUES ('combined_T0_T1');
INSERT INTO `operatorManagementDB`.`planType` (`plan`) VALUES ('combined_T0_T2');
INSERT INTO `operatorManagementDB`.`planType` (`plan`) VALUES ('combined_T1_T2');
